...
- JVM-Tests muessen fuer Safety, Privacy, Boot-Autostart, Kartenprovider, Hazard-Depth-Filter, Billing-Katalog, Play-Purchase-Mapping, Billing-Validation-JSON, Billing-Restore-Coordinator/-Mapping, Entitlements, Feature Access, lokale Crash-Reports und Diagnose-Export/Redaction gruen sein.
