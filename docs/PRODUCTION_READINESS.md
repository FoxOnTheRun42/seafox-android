...
- Feature-Access-Policy und Runtime-Gate ordnen Widgets und Kernfunktionen testbar `Free`, `Pro`, `Navigator` und `Fleet` zu; Premium-Widgets werden beim Hinzufuegen geblockt, ohne Kartenlizenzen mit App-Abos zu vermischen.
