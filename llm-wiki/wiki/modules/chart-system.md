...
- Checked unit-test surface: `ChartProviderRegistryTest`, `FreeRasterChartProvidersTest`, `SeaChartWidgetSettingsModuleTest`, `SafetyContourPolicyTest`, `HazardOverlayBuilderTest` and `GeoCalcTest` cover provider gating, free online raster contracts, persisted provider normalization, safety-depth policy, DEPARE/DEPCNT/SOUNDG shallow filtering and geometry math. Missing test coverage remains for the exact safety-contour contract feature shape and real rendered ENC screenshots.
