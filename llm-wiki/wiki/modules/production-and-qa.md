...
- `RuntimeEntitlementGateTest`: Premium-Widget-Erstellung und bestehende Premium-Widget-Nutzung werden gegen den persistierten App-Entitlement-Snapshot geprueft; Deny-Messages nennen erforderliche Stufe, Ablaufzustaende und trennen Kartenpakete von App-Features.
